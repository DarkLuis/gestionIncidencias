    ...
    <div class="panel-body">
       ...
       @endif
        ...
        <thead>
            ...
            <tbody>
                <tr>
                    ...
                    <td id="incident_category">{{ $incident->state }}</td>
                    <td id="incident_created_at">{{ $incident->severity_full }}</td>
                </tr>
            </tbody>
        </table> 
        ...
        @if (auth()->user()->id == $incident->client_id)
            @if ($incident->active)
                <a href="/incidencia/{{ $incident->id }}/resolver" class="btn btn-primary btn sm" id="incident_btn_solve">
            ...
            @else
                <a href="/incidencia/{{ $incident->id }}/abrir" class="btn btn-primary btn sm" id="incident_btn_open">
